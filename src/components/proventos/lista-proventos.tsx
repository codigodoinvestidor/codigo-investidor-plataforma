...
export function ListaProventos({ proventos, onRefresh }: { proventos: ProventoEditavel[]; onRefresh?: () => void }) {
  ...
  return (
    <>
      <div className="scrollbar-fina max-h-[480px] overflow-y-auto overflow-x-auto">
        <table className="w-full min-w-[680px] border-collapse text-sm">
          <thead>
            <tr className="sticky top-0 z-10 bg-superficie text-left text-xs uppercase tracking-wide text-foreground/40">
